    ...
    <body>
        ...
        <div class="w3-container">
            ...
            <div class="w3-panel w3-pale-blue w3-leftbar w3-rightbar w3-border-blue">
                <p>Este api es propio que busca departamentos con codigo dado como parametro en el URL de mi servidor
                    <br>
            ...
            <h3>Use de Api Rest de Buscar Usuarios </h3>
            <div class="w3-panel w3-pale-blue w3-leftbar w3-rightbar w3-border-blue">
                <p>Este api esta programado para buscar usuarios con su descripcion  dada como parametro en el URL de mi servidor Usando el <b>AJAX</b>
                    <br>
